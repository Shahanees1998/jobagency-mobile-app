...
const ICON_BG = '#5A8D9B';
const BTN_BG = '#2A5A6A';

export default function JobUpdatedScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Job updated</Text>
        <View style={styles.headerBtn} />
      </View>
      <View style={[styles.content, { paddingBottom: insets.bottom + 24 }]}>
        <View style={styles.iconWrap}>
          <Ionicons name="briefcase" size={56} color={APP_COLORS.white} />
        </View>
        <Text style={styles.title}>Your job has been updated successfully !!</Text>
        <Text style={styles.subtext}>
          The changes to your job listing have been saved. Candidates will now see the updated information.
        </Text>
        <TouchableOpacity
