...
export default function InterviewScheduledScreen() {
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.title}>Interview has been scheduled successfully !!</Text>
        <Text style={styles.subtext}>
          The candidate will see the interview details. You can edit or delete it from the interview listing.
        </Text>
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 20, fontWeight: '700', color: APP_COLORS.textPrimary, textAlign: 'center', marginBottom: 12 },
